...
$alut_ad = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
...
$drillad = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AD'
GROUP BY kategori") or die (mysqli_error());
while($dad = mysqli_fetch_assoc($drillad)){		

		$subad = mysqli_query($con, "SELECT subkategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AD' AND kategori='$dad[kategori]'
GROUP BY subkategori") or die (mysqli_error());
		
		while($sad = mysqli_fetch_assoc($subad)){

				$datasubad[] =  array($sad['subkategori'], (double)$sad['jumlah']);
...
$alut_al = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
...
$drillal = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AL'
GROUP BY kategori") or die (mysqli_error());
...
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AL' AND kategori='$dal[kategori]'
GROUP BY subkategori") or die (mysqli_error());
		
		while($sal = mysqli_fetch_assoc($subal)){

				$datasubal[] =  array($sal['subkategori'], (double)$sal['jumlah']);
...
$alut_au = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AU'
GROUP BY kategori") or die (mysqli_error());
		
		while($al = mysqli_fetch_assoc($alut_au)){
...
$drillau = mysqli_query($con, "SELECT kategori, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AU'
GROUP BY kategori") or die (mysqli_error());
...
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') AND matra = 'TNI AU' AND kategori='$dau[kategori]'
GROUP BY subkategori") or die (mysqli_error());
		
		while($sau = mysqli_fetch_assoc($subau)){

				$datasubau[] =  array($sau['subkategori'], (double)$sau['jumlah']);
...
$alut = mysqli_query($con, "SELECT matra, SUM(CAST(REPLACE(jumlah,',','') AS UNSIGNED)) AS jumlah 
FROM tbl_alutmatra WHERE ('$getYearsNow'-tahun) > 50 
AND (tahun!='' OR tahun!='-') 
GROUP BY matra") or die (mysqli_error());
