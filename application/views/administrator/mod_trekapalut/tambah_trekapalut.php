        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open('administrator/tambah_trekapalut',$attributes); ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="c" placeholder="Masukan Sub Kategori">
                  </div>
                </div>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="d" placeholder="Masukan Jenis">
                  </div>
                </div>
