        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open('administrator/ubah_satker',$attributes); ?>
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="e" value="<?=$row['tni']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="number" name="h" class="form-control" value="<?=$row['thnadk']?>">
                  </div>
                </div>
