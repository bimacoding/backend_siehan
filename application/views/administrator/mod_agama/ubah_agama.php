        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open('administrator/ubah_agama',$attributes); ?>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Kode Agama</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?=$row['ID_AGAMA']?>">
                    <input type="text" class="form-control" name="a" value="<?=$row['KDAGAMA']?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Agama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="b" value="<?=$row['AGAMA']?>">
                  </div>
                </div>
                <hr>
