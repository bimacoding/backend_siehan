        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open('administrator/ubah_pangkat',$attributes); ?>
              <input type="hidden" name="id" value="<?=$row['row_id']?>">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Kode Pangkat</label>
                  <div class="col-sm-10">
                    <input type="text" name="a" class="form-control" value="<?=$row['kd_pkt']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="b" class="form-control" value="<?=$row['nm_pkt']?>">
                  </div>
                </div>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="c" value="<?=$row['esl']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="d" value="<?=$row['gol']?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="e" value="<?=$row['kd_gol']?>">
                  </div>
                </div>
