            ...
            <div class="card-body">
              ...
              <input type="hidden" name="id" value="<?=$row['id']?>">
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="a" value="<?=$row['tahun']?>">
                  </div>
                </div>
                ...
                <script type="text/javascript">
                 $(document).ready(function(){
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="c" value="<?=$row['pria']?>">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="d" value="<?=$row['wanita']?>">
                  </div>
                </div>    
