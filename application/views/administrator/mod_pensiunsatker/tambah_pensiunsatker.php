            ...
            <div class="card-body">
              ...
              echo form_open('administrator/tambah_pensiunsatker',$attributes); ?>
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="c" placeholder="Masukan Kode Satker">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="d" class="form-control" placeholder="masukan nama satker">
                  </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="e" class="form-control" placeholder="masukan jumlah tni">
                  </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="h" placeholder="masukan tahun">
                  </div>
                </div>
