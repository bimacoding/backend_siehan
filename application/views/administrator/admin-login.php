...
<body class="hold-transition login-page" style="background-image: url('./assets/images/bg-login.jpg');background-size: cover;">
<div class="login-box">
  <!-- <div class="login-logo">
    <a href="#">SIEHAN ADMIN</a>
  </div> -->
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Silahkan Login Pada Form dibawah ini</p>
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Username" name="a">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" name="b">
          <div class="input-group-append">
            <div class="input-group-text">
