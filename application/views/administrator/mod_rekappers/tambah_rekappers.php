        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open('administrator/tambah_rekappers',$attributes); ?>
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type=text hidden name="f" id="nmgol">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="e" class="form-control" placeholder="masukan nama singkatan">
                  </div>
                </div>
 ...
 -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="h" class="form-control" placeholder="masukan jumlah">
                  </div>
                </div>
